...
class Settings(BaseSettings):
    ...
    # the LLM's response back to real values. Runs as a sibling process in
    # the same container (see root Dockerfile / docker/supervisord.conf).
    pii_service_url: str = "http://127.0.0.1:8100"
